...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		//intent.putExtra("UINTENT", "USPJEH");
	...
	private void startImplicitActivation() {
		...
		Intent chooserIntent = Intent.createChooser(intent, "Odaberi activity koji ce procesirati intent");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(requestCode == GET_TEXT_REQUEST_CODE &&
			...
			String resultValue = data.getExtras().getString("EXTRAMOJE");
			mUserTextView.setText(resultValue);
		}
	}
}
